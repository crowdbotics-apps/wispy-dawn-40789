...
const ScreenTwo = () => {
  return <View style={styles.container}>
      <View style={styles.header}>
        <Pressable><Text style={styles.headerText}>Tasks</Text></Pressable>
      </View>
      <View style={styles.taskContainer}>
        <TouchableOpacity style={styles.taskButton}>
          <Pressable><Image source={{
            uri: 'https://tinyurl.com/42evm3m3'
          }} style={styles.taskImage} /></Pressable>
        ...
        <TouchableOpacity style={styles.taskButton}>
          ...
          <Text style={styles.taskText}>Task 5</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.taskButton}>
          <Image source={{
          uri: 'https://tinyurl.com/42evm3m3'
        }} style={styles.taskImage} />
          <Text style={styles.taskText}>Task 6</Text>
        </TouchableOpacity>
      </View>
    </View>;
};
